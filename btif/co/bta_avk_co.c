...
/******************************************************************************
 *
 *  Callout functions for A2DP Sink
 *
 ******************************************************************************/
...
#define BTA_AVK_CO_AUDIO_HNDL_TO_INDX(hndl) (((hndl) & (~BTA_AV_CHNL_MSK)) - 1)
#define BTA_AVK_CO_AUDIO_INDX_TO_HNDL(indx) (((indx) + 1) | BTA_AV_CHNL_AUDIO)
...
typedef struct
{
    ...
    tBTA_AVK_CO_PEER peers[BTA_AV_NUM_STRS];
    /* Current codec configuration - access to this variable must be protected */
    tBTIF_AV_CODEC_INFO codec_cfg;           /* preferred codec config */
 ...
 **
 *******************************************************************************/
static tBTA_AVK_CO_PEER *bta_avk_co_get_peer(tBTA_AV_HNDL hndl)
{
    UINT8 index;
    FUNC_TRACE();
 ...
 **
 *******************************************************************************/
static BOOLEAN append_codec(tBTA_AV_CODEC codec_type, tBTA_AV_HNDL hndl)
{
    int index = 0;
        ...
        UINT8 *p_protect_info, UINT8 index)
{
    ...
    *p_protect_info = 0;
    ...
    bta_avk_co_cb.codec_cfg_setconfig.id = BTIF_AV_CODEC_NONE;
 ...
 **
 *******************************************************************************/
void bta_avk_co_audio_disc_res(tBTA_AV_HNDL hndl, UINT8 num_seps, UINT8 num_snk,
...
void bta_avk_build_sbc_src_cfg (UINT8 *p_pref_cfg, UINT8 *p_src_cap)
{
    ...
    A2D_BldSbcInfo(AVDT_MEDIA_AUDIO, (tA2D_SBC_CIE *) &btif_avk_sbc_default_config, p_pref_cfg);
 ...
 **
 *******************************************************************************/
UINT8 bta_avk_co_audio_getconfig(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type,
 ...
 **
 *******************************************************************************/
void bta_avk_co_audio_setconfig(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type,
 ...
 **
 *******************************************************************************/
void bta_avk_co_audio_open(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type, UINT8 *p_codec_info,
        UINT16 mtu)
{
    tBTA_AVK_CO_PEER *p_peer;
    UNUSED(p_codec_info);
 ...
 **
 *******************************************************************************/
void bta_avk_co_audio_close(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type, UINT16 mtu)
 ...
 **
 *******************************************************************************/
void bta_avk_co_audio_start(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type,
 ...
 **
 *******************************************************************************/
void * bta_avk_co_audio_sink_data_path(tBTA_AV_CODEC codec_type, UINT32 *p_len,
        UINT32 *p_timestamp)
{
 ...
 **
 *******************************************************************************/
void bta_avk_co_audio_delay(tBTA_AV_HNDL hndl, UINT16 delay)
{
    FUNC_TRACE();
...
/*******************************************************************************
 **
 ** Function         bta_avk_co_audio_supports_config
 **
...
static BOOLEAN bta_avk_co_audio_supports_config(UINT8 codec_type, const UINT8 *p_codec_cfg)
{
    ...
    {
    case BTA_AV_CODEC_SBC:
        if (bta_av_sbc_cfg_in_cap((UINT8 *)p_codec_cfg, (tA2D_SBC_CIE *)&bta_avk_co_sbc_caps))
        {
            return FALSE;
        }
        break;
#if defined(AAC_DECODER_INCLUDED) && (AAC_DECODER_INCLUDED == TRUE)
    case BTA_AV_CODEC_M24:
        if (bta_av_aac_cfg_in_cap((UINT8 *)p_codec_cfg, (tA2D_AAC_CIE *)&bta_avk_co_aac_caps))
        {
            return FALSE;
        }
        break;
